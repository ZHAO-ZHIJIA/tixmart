...
SELECT UserID FROM Users WHERE Email = 'newuser2@example.com';
-- 假設回傳 UserID = 8
...
-- 查詢訂單總覽
SELECT * FROM Orders WHERE UserID = 8;
